...
final class ExtendedBufferedReader extends BufferedReader {
    ...
    private @IntRange(from=-2, to=65535) int lastChar = UNDEFINED;
     ...
     */
    @IntRange(from=-2, to=65535) int getLastChar() {
        return lastChar;
    }

    @Override
    public @IntRange(from=-1, to=2147483647) int read(final char[] buf, final int offset, final int length) throws IOException {
        if (length == 0) {
            return 0;
        }
