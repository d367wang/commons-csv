...
import cast.qual.EnsuresIntValIf;
...
final class Lexer implements Closeable {
     ...
     *             on stream access error
     */
    private Token parseSimpleToken(final Token token, @IntRange(from=-1, to=65535) int ch) throws IOException {
     ...
     */
    @IntRange(from=-1, to=65535) int readEscape() throws IOException {
     ...
     */
    boolean isWhitespace(final @IntRange(from=0, to=65535) int ch) {
	...
	@EnsuresIntValIf(expression="#1", result=true, value=-1)
    ...
    @EnsuresIntRangeIf(expression="#1", result=true, from=0, to=65535)
